<%@ Page Title="主页" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeBehind="Default.aspx.cs" Inherits="GoogleMapDemo._Default" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <asp:TextBox ID="TextBox" runat="server" Text="<%# this.GetNameCookie() %>">
    </asp:TextBox>
    <input id="input" type ="text" value="<%=strDate %>" />
</asp:Content>
