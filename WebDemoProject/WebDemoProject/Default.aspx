...
<body>
	...
	<telerik:RadAjaxManager ID="RadAjaxManager1" runat="server">
        ...
        <telerik:RadSplitter ID="MainSplitter" runat="server" Height="432px" 
            Width="790px" Orientation="Horizontal">
            <telerik:RadPane ID="RadPane2" Runat="server" Height="227px" Width="764px">
                <div>
                    <table class="style1">
                        <tr>
                        ...
                        <tr>
                            ...
                            <td class="style14">
                                &nbsp;</td>
                            <td>
                                <telerik:RadButton ID="btnPrintGauge" runat="server" 
                                    NavigateUrl="~/GaugeReport.aspx" onclick="btnPrintGauge_Click" 
                                    Text="Print Gauge">
                                </telerik:RadButton>
                            </td>
                        </tr>
            ...
            <telerik:RadPane ID="RadPane1" runat="server" Height="179px" Width="764px">
